class Rediseen < Formula
  ...
  url "https://github.com/XD-DENG/rediseen/archive/1.0.1.tar.gz"
  sha256 "adc6ef63b3550fd40fdddbcd73c76a20a3cc547a762acce864bbfe23e0a692fa"
  ...
  test do
    assert_equal "1.0.1", shell_output("#{bin}/#{name} version").strip
