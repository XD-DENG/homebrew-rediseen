class Rediseen < Formula
  ...
  url "https://github.com/XD-DENG/rediseen/archive/1.2.0.tar.gz"
  sha256 "05fd584f04c888974adb9c812c92d4795d9298b73ce45068f6b6500ea2f8f4a2"
  ...
  test do
    assert_match "1.2.0", shell_output("#{bin}/#{name} version").strip
